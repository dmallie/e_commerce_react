...
<div className='table_container'>
       <table>
              ...
              <tbody>
              {
                     cartObject.orders.map((anOrder, index) => {
                            // console.log('Order: ', anOrder);
                            return (
                                   <CartOrder {...anOrder} key={index} 
                                                 parentCallback={updateValues}/>
                            )
                     })
              }
              </tbody>
       ...
       <div className="btn-container_">
              ...
              <button className='btn clr-btn'>clear shopping cart</button>
       </div>
       <div className='summary-container'>
              <div className='summary-section'>
                     <h5>subtotal: <span>$ {subTotal}</span></h5>
                     <p>shipping fee: <span>$ {cartObject.shippingFee }</span></p>
                     <hr />
                     <h4>Order Total: <span> $ { totalValue }</span> </h4>
              </div>
       </div>
       <div className='summary-container'>
